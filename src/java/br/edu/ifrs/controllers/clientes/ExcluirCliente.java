...
public class ExcluirCliente extends HttpServlet {
    ...
    private NotaFiscalVendaProduto notaFiscalVendaProduto;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(clientesRepository.removeById(id) == 0) {
                out.println("Não foi possivel excluir o cliente pois ele está vinculado a alguma nota fiscal de venda.<br><br>");
                out.println("<a href=\"ListarClientes\">Listar Clientes</a>");
                return;
            }
            
            out.println("<script> window.location = 'ListarClientes'; </script>");
        }
    }
