...
public class CadastrarCliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Cliente cliente = new Cliente(request.getParameter("cpf"), request.getParameter("nome"));
                        
            cliente = clientesRepository.insert(cliente);
            
            out.printf("<p>Cliente %s salvo com sucesso!!!</p>", cliente.getNome());
            out.println("<a href=\"FormCliente\">Inserir Novo Cliente</a>");
