...
public class CadastrarProduto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Produto produto = new Produto(formNome, formDescricao, formPreco);
            
            produtosRepository.insert(produto);
            
            out.printf("<p>Produto %s salvo com sucesso!!!</p>", produto.getNome());
            out.println("<a href=\"FormProduto\">Inserir Novo Produto</a>");
